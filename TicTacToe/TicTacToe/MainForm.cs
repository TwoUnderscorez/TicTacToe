...
namespace TicTacToe
{
    public partial class MainForm : Form
    {
        ...
        private async Task<TTTBox[,]> MiniMaxAsync(TTTBox[,] gameBoard, int alpha, int beta, int depth, bool turnForPlayerX)
        {
        ...
        private void PCPlay()
        {
            TTTBox[,] newGameBoard;
            Enabled = false;
            var worker = MiniMaxAsync(TTTBoxes, int.MinValue + 1, int.MaxValue - 1, Properties.Settings.Default.difficulty, Properties.Settings.Default.playerO);
